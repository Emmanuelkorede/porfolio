...
export function MiddleContent() {
  ...
  return (
    <div className="flex flex-col justify-center h-full gap-6 lg:gap-8 w-full py-6 md:py-0">
      ...
      <div>
        <h1 className="text-4xl sm:text-5xl lg:text-4xl xl:text-5xl font-sans font-bold text-foreground leading-[1.08] tracking-tight">
      ...
      {/* Stats Counter Row */}
      <div className="flex items-center gap-8 sm:gap-10 pt-4 border-t border-border/30">
        <div>
          <p className="text-3xl sm:text-4xl lg:text-3xl xl:text-4xl font-sans font-bold text-foreground tracking-tight">
            2+
          </p>
